                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="mb-2">
                                ...
                                <input type="text" name="teacherSchoolId" class="form-control form-control-sm"
                                    id="teacherId" aria-describedby="" required>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="firstName" class="form-control form-control-sm" id=""
                                    aria-describedby="" required>
                            </div>
                            <div class="mb-2">
                                ...
                                <input type="text" name="middleName" class="form-control form-control-sm"
                                    id="middleName" aria-describedby="" required>
                            </div>
                            <div class="col">
                                <div class="mb-2">
                  ...
                  aria-describedby="" required>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="password" name="password" class="form-control form-control-sm"
                                    id="password" value="abcxyz123" aria-describedby="" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <select id="teacherRoleSelect" name="teacherRoleSelect"
                                        class="form-select form-select-sm">
                                        <option value="">Choose:</option>
    ...
    <div class="modal fade" id="editTeacherModal" tabindex="-1" aria-labelledby="editTeacherModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" id="editTeachersForm">
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" id="editTeacherDbId" name="editTeacherDbId" />

                            <div class="mb-2">
                                <label for="editTeacherId" class="form-label"><small>Teacher ID</small></label>
                                <input type="text" name="editTeacherSchoolId" class="form-control form-control-sm"
                                    id="editTeacherId" required>
                            </div>
                            <div class="mb-2">
                                <label for="editLastName" class="form-label"><small>Last Name</small></label>
                                <input type="text" name="editLastName" class="form-control form-control-sm"
                                    id="editLastName" required>
                            </div>
                            <div class="mb-2">
                                <label for="editFirstName" class="form-label"><small>First Name</small></label>
                                <input type="text" name="editFirstName" class="form-control form-control-sm"
                                    id="editFirstName" required>
                            </div>
                            <div class="mb-2">
                                <label for="editMiddleName" class="form-label"><small>Middle Name</small></label>
                                <input type="text" name="editMiddleName" class="form-control form-control-sm"
                                    id="editMiddleName" required>
                            </div>
                            <div class="col">
                                <div class="mb-2">
                                    <label for="editDepartmentSelect" class="form-label mb-0">
                                        <small>Department</small>
                                    </label>
                                    <select id="editDepartmentSelect" name="editDepartmentSelect"
                                        class="form-select form-select-sm">
                                        <option value="">Choose:</option>
                                        <?php foreach ($departments as $department): ?>
                                        <option value="<?= $department['id'] ?>"><?= $department['department'] ?>
                            ...
                            <div class="mb-2">
                                <label for="editPassword" class="form-label"><small>Password</small></label>
                                <input type="password" name="editPassword" class="form-control form-control-sm"
                                    id="editPassword" value="abcxyz123" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-2">
                                    <label for="editStatusSelect" class="form-label mb-0">
                                        <small>Status</small>
                                    </label>
                                    <select id="editStatusSelect" name="editStatusSelect"
                                        class="form-select form-select-sm">
                                        <option value="">Choose:</option>
                                        <?php foreach ($statuses as $status): ?>
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    <label for="editTeacherRoleSelect" class="form-label mb-0">
                                        <small>Role</small>
                                    </label>
                                    <select id="editTeacherRoleSelect" name="editTeacherRoleSelect"
                                        class="form-select form-select-sm">
                                        <option value="">Choose:</option>
                                        <?php foreach ($roles as $role): ?>
